...
if dashboard:
    ...
    try:
        ...
        col3.write("*N : Too many values to count*")
        fig=go.Figure()
        ...
        col2.write('*N:*'+str([pd_postop_outcomes['UPDRS II'].count(),pd_postop_outcomes['UPDRS II.1'].count(),pd_postop_outcomes['UPDRS II.2'].count()]))
        fig=go.Figure()
        ...
        col1.write('*N:*'+str([pd_postop_outcomes['UPDRS I'].count(),pd_postop_outcomes['UPDRS I.1'].count(),pd_postop_outcomes['UPDRS I.2'].count()]))
        fig=go.Figure()
        ...
        col1.plotly_chart(fig)
        col1.write('*N:*'+str([pd_postop_outcomes['PDQ39 pre'].count(),pd_postop_outcomes['6 mon PDQ39'].count(),pd_postop_outcomes['1 yr PDQ39'].count()]))
        fig=go.Figure()
        ...
        col2.plotly_chart(fig)
        col2.write('*N:*'+str([pd_postop_outcomes['Balance:MiniBest'].count(),pd_postop_outcomes['MiniBest @6mon'].count(),pd_postop_outcomes['MiniBest @1yr'].count()]))
